...
<div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 20px; max-width: 100%; margin: auto; overflow: hidden;">
  <div style="flex: 1 1 45%; min-width: 450px; max-width: 600px;">
